...
table {
  border: 0.1rem solid var(--c-primary-900);
  padding: 0;
  margin: 0;
  border-spacing: 0;
  width: 100%;
...
table th {
  ...
  margin: 0;
  text-align: left;
  border-bottom: 0.1rem solid var(--c-primary-900);
}
...
table tr td {
  padding: 0 0.25rem;
  border-bottom: 0.1rem solid var(--c-primary-400);
}
...
table tbody tr:hover {
  outline: 0.2rem solid var(--c-primary-900);
}
